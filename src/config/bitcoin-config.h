...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Granadeiro developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Granadeiro"
...
#define PACKAGE_BUGREPORT "https://github.com/granadeirograna"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Granadeiro"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Granadeiro 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "granadeiro"
